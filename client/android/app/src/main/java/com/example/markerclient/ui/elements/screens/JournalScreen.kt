...
import com.example.markerclient.ui.elements.components.EntryContent
        ...
        navigationTrailingButton.updateButton(
            ...
            action = {
                scope.launch {
                    ...
                    entryViewModel.addEntry{ entryId ->
                        val entry = entryViewModel.getEntryById(entryId)
                        if(entry != null){
                            customDismissCard.update(
                                visible = true,
    ...
    Box(modifier = modifier){
        ...
        IconButton(
            modifier = Modifier.align(Alignment.TopEnd)
                .wrapContentSize(),
            onClick = {
                entryViewModel.deleteEntry(entry.entryId)
            }
        ) {
            Icon(
