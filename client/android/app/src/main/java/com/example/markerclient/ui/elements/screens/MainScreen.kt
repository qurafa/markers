...
import com.example.markerclient.ui.viewModel.MarkViewModel
import com.example.markerclient.domain.model.ToolbarTrailingButton
import com.example.markerclient.ui.viewModel.EntryViewModel
import com.example.markerclient.ui.elements.components.AppFloatingNavigationToolBar
import com.example.markerclient.ui.elements.components.CustomDismissableCard
...
enum class MarkerScreen(@StringRes val title: Int){
    ...
    Journal(title = R.string.journal_screen),
    Audio(title = R.string.audio_screen),
...
fun MainScreen(navController: NavHostController) {
    ...
    )
    {
        ...
        )
        {
            ...
            // Add card for pop up information with its default modifier to be stacked on top of later
